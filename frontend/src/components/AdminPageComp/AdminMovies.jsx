...
const AdminMovies = ({addMovieForm, scheduleMovieForm}) => {
  ...
  const [editMovieForm, setEditMovieForm] = useState({ formOpen: false, movieId: 0 });;
  ...
  console.log(editMovieForm.formOpen);
  console.log(editMovieForm.movieId);
  return (
      <div className="admin__movies__container">
        ...
        {editMovieForm.formOpen && <EditMovieForm movieId={editMovieForm.movieId} />}
    </div>
